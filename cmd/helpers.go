...
func getAppReleasesFromApps(b *bosun.Bosun, repos []*bosun.App) ([]*bosun.AppRelease, error) {
...
func mustGetApps(b *bosun.Bosun, names []string) []*bosun.App {
	repos, err := getApps(b, names)
	if err != nil {
		log.Fatal(err)
	}
	if len(repos) == 0 {
