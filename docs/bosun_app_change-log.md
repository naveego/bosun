## bosun app change-log

Prints a change log in console

### Synopsis

Prints a changelog of changes. 'to' is by default 'master'

```
bosun app change-log {app} {from} [to] [flags]
```

### Options

```
  -d, --details   Will output more details
