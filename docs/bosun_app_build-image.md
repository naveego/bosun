## bosun app build-image

Builds the image(s) for an app.

### Synopsis

If app is not provided, the current directory is used. The image(s) will be built with the "latest" tag.

```
bosun app build-image [app] [flags]
```
